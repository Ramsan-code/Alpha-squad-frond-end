        ...
        try {
            ...
            if (response.success) {
                toast.success("Registration successful!", {
                    description: "Your instructor account is pending admin approval. You can login once approved.",
                });
                router.push("/login");
            }
        } catch (error: any) {
            ...
            <div className="flex-1 flex items-center justify-center p-6 -mt-12">
                <Card className="w-full max-w-md glass border-white/10">
                    <CardHeader className="space-y-1">
                        ...
                        <CardTitle className="text-2xl font-bold">Instructor Registration</CardTitle>
                        <CardDescription>
                            Share your knowledge and mentor the next generation
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
